...
namespace SPG_Fachtheorie.Aufgabe1.Test
{
    public class PaymentServiceTests
    {
        ...
        // Update all TestCashier instantiations to include the 'jobSpezialisation' parameter.
        [Theory]
        ...
        public void CreatePaymentExceptionsTest(int cashDeskNr, string type, int employeeNr, string expectedError)
        {
            ...
            if (employeeNr > 0)
            {
                context.Employees.Add(new TestCashier(employeeNr, "Max", "Muster", DateOnly.FromDateTime(DateTime.Today), null, null, "DefaultJobSpecialisation"));
        ...
        public void ConfirmPaymentExceptionsTest()
        {
            ...
            var emp = new TestCashier(1, "A", "B", DateOnly.FromDateTime(DateTime.Today), null, null, "DefaultJobSpecialisation");
        ...
        // Fix for CS7036: Add the missing 'jobSpezialisation' parameter to the TestCashier constructor calls.
        ...
        {
            public TestCashier(int reg, string f, string l, DateOnly b, decimal? s, Address? a, string jobSpezialisation)
                : base(reg, f, l, b, s, a, jobSpezialisation)
            {
                Type = "Cashier";
            }
        }
